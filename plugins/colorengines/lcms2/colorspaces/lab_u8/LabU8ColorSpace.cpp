...
void LabU8ColorSpace::toYCbCr(QVector <double> channelValues, qreal *y, qreal *cb, qreal *cr) const
{
    *y =channelValues[0];
    *cr=channelValues[1];
    *cb=channelValues[2];
...
QVector <double> LabU8ColorSpace::fromYCbCr(qreal *y, qreal *cb, qreal *cr) const
{
    QVector <double> channelValues(4);
    channelValues[0]=*y;
    channelValues[1]=*cr;
