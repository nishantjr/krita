...
void XyzF32ColorSpace::toYCbCr(QVector <double> channelValues, qreal *y, qreal *cb, qreal *cr) const
{
    XYZToxyY(channelValues[0],channelValues[1],channelValues[2], cb, cr, y);
}

QVector <double> XyzF32ColorSpace::fromYCbCr(qreal *y, qreal *cb, qreal *cr) const
{
    QVector <double> channelValues(4);
