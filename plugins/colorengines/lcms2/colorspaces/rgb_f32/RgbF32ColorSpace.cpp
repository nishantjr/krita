...
void RgbF32ColorSpace::toYCbCr(QVector <double> channelValues, qreal *y, qreal *cb, qreal *cr) const
{
    QVector <double> colorants(9);
    if (profile()->hasColorants()){
        colorants = profile()->getColorantsxyY();
...
QVector <double> RgbF32ColorSpace::fromYCbCr(qreal *y, qreal *cb, qreal *cr) const
{
    QVector <double> channelValues(4);
    QVector <double> colorants(9);
    if (profile()->hasColorants()){
